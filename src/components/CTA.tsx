        ...
        <Container>
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 md:gap-20">
            <div>
              ...
              <div className="mt-8">
                <Link href="/products" className="inline-block text-sm font-semibold uppercase tracking-wider text-white transition-all hover:opacity-90" style={{ backgroundColor: "#ff2e88", padding: "14px 32px" }}>
                  Shop Now
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "#0d0509" }}>
        <Container className="max-w-xl text-center">
          ...
          <form className="mt-8 flex flex-col gap-3 sm:flex-row" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="text-sm font-semibold uppercase tracking-wider transition-all hover:opacity-90" style={{ backgroundColor: "#ff2e88", color: "#f8eef3", padding: "14px 32px" }}>
              Subscribe
            </button>
          </form>
        </Container>
