      ...
      <div className="relative z-10 mx-auto w-full max-w-[var(--container-max)] px-[var(--container-padding)]">
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link href="/products" className="inline-block text-sm font-semibold uppercase tracking-wider text-white transition-all hover:scale-105" style={{ backgroundColor: "#ff2e88", padding: "14px 40px" }}>
              Shop Now
            </Link>
            <Link href="#featured" className="inline-block text-sm font-semibold uppercase tracking-wider transition-all hover:bg-white hover:text-black" style={{ color: "#f8eef3", border: "2px solid #f8eef3", padding: "14px 40px" }}>
              View Collection
            </Link>
          </div>
        </div>
